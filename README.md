...
| [Visium_sagittal_anterior_mouse_brain_Sparse](./demo_notebooks/Visium_sagittal_anterior_mouse_brain_Sparse.ipynb)| Applying GPcounts on visium data to identify spatially expressed genes on spatial data from Sagittal Anterior Mouse Nrain. This notebook demonstrates applying a sparse GPcounts model on visium data and generate scales factor usign python's 'statsmodels' module.|
